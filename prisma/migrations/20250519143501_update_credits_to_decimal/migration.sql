...
-- Update PurchaseTransaction.credits to use Decimal type with 2 decimal places
ALTER TABLE "PurchaseTransaction" ALTER COLUMN "credits" TYPE DECIMAL(10,2) USING (credits::DECIMAL(10,2));