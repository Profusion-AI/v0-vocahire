...
```json
{
  ...
  "messageCount": 15,
  "lastActivity": "2025-05-26T10:05:00Z"
}
```
...
#### control.end
**Purpose**: End the interview session
```json
{
  "type": "control.end",
  "timestamp": "2025-05-26T10:00:00Z",
...
```json
{
  ...
  "timestamp": "2025-05-26T10:00:00Z",
  "data": {
    "status": "connected", // connected, active, paused, ending, completed
...
```json
{
  ...
  "data": {
    "pong": 1234567890,
    "serverTime": "2025-05-26T10:00:01Z"
  }
}
```
